...
rewriteTopology[qasmPath_,outputPath_]:=
...
(* Error-handling *)
If[
qasmLength<=1||Length@initPos!=1||WeaklyConnectedGraphQ[topoGraph]!=True,
...
cxUndRew=Table[undRewExp[n],{n,cxRouteList}];

(* DIRECTED REWRITING *)
cxDirRew=dirRewLnr[cxUndRew,topoList];
...
rewriteTopology[ToString[$CommandLine[[-2]]],ToString[$CommandLine[[-1]]]];
